...
Function Setup-Firewall {
    ...
    # Allow dynamic outbound ports for application compatibility
    netsh advfirewall firewall add rule name="Allow 8000" protocol=TCP dir=out localport=8000 action=allow
    netsh advfirewall firewall add rule name="Allow 8000" protocol=TCP dir=in localport=8000 action=allow
    Write-Host "Port 8000 has a key"
